...
export default function TrendingCurrentPage() {
  ...
  useEffect(() => {
    ...
    async function run() {
      ...
      try {
        ...
        if (!isCancelled) {
          setItems([]);
          setErr("Failed to load current trending.");
        }
      } finally {
  ...
  return (
    <div className="app-page">
      <div className="page-header">
        <h2 className="page-title">Current Trending</h2>
      </div>
      {isLoading ? (
